...
docker run -it -d --name h24 -e UID=$(id -u $USER) -e GID=$(id -g $USER) -v "$PWD/data:/home/h24/source/prepared_data_IDF" -v "$PWD/result:/home/h24/source/results_IDF" h24:latest
